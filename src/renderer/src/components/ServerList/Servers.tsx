...
export function Servers({
  ...
  const isDuplicateName = useMemo(() => {
    ...
    return servers.some((s, i) => i !== editingIndex && s.name.trim().toLowerCase() === nextName)
                ...
                <ScrollShadow className="h-80">
                  <div className="flex flex-col gap-2 pr-1">
                    {servers.map((server, index) => {
                      ...
                      if (index === servers.length - 1) disabledKeys.add('moveDown')
                                ...
                                >
                                  {isEditing ? (
                                    <Button
                                      ...
                                      isIconOnly
                                      onPress={() => {
                                        const nextValue = cycleTextures(server.acceptTextures)
                                      ...
                                      <DropdownMenu disabledKeys={[...disabledKeys]}>
                                        ...
                                        <DropdownItem
                                          ...
                                          startContent={
                                            <Zap
                                              color={
                                                quickConnectIp != server.ip ? 'yellow' : 'white'
                                              }
                                              size={20}
                                            />
                                          }
                                          onPress={() => {
                                            setQuickConnectIp(
                                              quickConnectIp === server.ip ? '' : server.ip
                                            )
                                          }}
                                        >
