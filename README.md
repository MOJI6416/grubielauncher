...
- **Code Signing Policy:** [grubielauncher.com/code-signing](https://grubielauncher.com/code-signing)
...
- Support for **Microsoft/Mojang** accounts, selected third-party authentication providers (such as **Ely.by** and **Discord**), and local profiles for development or private testing.
...
- Signed Windows release artifacts are built from the public source code repository and official release tags.
- Signed artifacts may include Windows installer `.exe` files and application binaries generated by the official release pipeline.
- **Signing approver:** Dmytro Burmych / MOJI6416.
- **Privacy Policy:** [grubielauncher.com/privacy](https://grubielauncher.com/privacy)
- **Code Signing Policy:** [grubielauncher.com/code-signing](https://grubielauncher.com/code-signing)
